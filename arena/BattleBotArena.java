...
public class BattleBotArena extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener, ActionListener, Runnable {
	 ...
	 */
	public static final int RIGHT_EDGE = 800; //ROWBOTTOM - changed from 700// also arena panel width
	/**
	 * Bottom edge of the screen
	 */
	public static final int BOTTOM_EDGE = 600; //ROWBOTTOM - changed from 500// arena panel height is this constant + TEXT_BUFFER
	/**
	...
	public static int getTEXT_BUFFER() {
		return TEXT_BUFFER;
	}
